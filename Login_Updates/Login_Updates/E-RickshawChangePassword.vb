...
Public Class E_RickshawChangePassword

    Dim cmdUpdate As New OleDbCommand
    Dim username As String
    Dim password As String
    Private Sub E_RickshawChangePassword_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Text = Erickshawlogin.TextBox1.Text
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            If password = pass Then
                cmdUpdate.CommandText = "UPDATE [E-RickshawData] SET [Password] = '" & TextBox4.Text & "'  Where [UserName] = '" & TextBox1.Text & "';"
