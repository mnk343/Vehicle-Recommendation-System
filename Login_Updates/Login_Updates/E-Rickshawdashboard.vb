...
Public Class E_Rickshawdashboard
    ...
    Private Sub E_Rickshawdashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load


        Label2.Text = Erickshawlogin.TextBox1.Text
